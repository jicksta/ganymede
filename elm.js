...
Elm.Ganymede = Elm.Ganymede || {};
Elm.Ganymede.make = function (_elm) {
   "use strict";
   _elm.Ganymede = _elm.Ganymede || {};
   if (_elm.Ganymede.values) return _elm.Ganymede.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var _op = {};
   var view = F2(function (address,model) {    return $Html.text("Hello world!");});
   var update = F2(function (action,model) {    return true;});
   var model = true;
   var main = $StartApp$Simple.start({model: model,view: view,update: update});
   return _elm.Ganymede.values = {_op: _op,main: main,model: model,update: update,view: view};
};
